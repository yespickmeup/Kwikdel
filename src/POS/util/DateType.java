...
import POS.metered_sales.Dlg_metered_sales;
...
public class DateType {
    ...
    public static SimpleDateFormat datetime2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS");
    ...
    public static SimpleDateFormat period_from = new SimpleDateFormat("MMMMMMMMMM dd");
    public static SimpleDateFormat period_to = new SimpleDateFormat("MMMMMMMMMM dd, yyyy");
    ...
    public static String convert_datetime_to_sf(String datetime) {
        String date = "";
        Date d = new Date();
        if (datetime.isEmpty()) {
            datetime = DateType.datetime.format(new Date());
    ...
    public static String to_period(String date_from, String date_to) {

        String date = "";

        try {
            Date from = DateType.sf.parse(date_from);
            Date too = DateType.sf.parse(date_to);

            date = DateType.period_from.format(from) + " to " + DateType.period_to.format(too);
        } catch (ParseException ex) {
