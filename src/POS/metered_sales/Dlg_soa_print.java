...
//        get_data("");
    ...
    public void do_pass( List<Srpt_readings.field> datas,String customer) {
        get_data(datas,customer);
    }
...
//                btn_0.doClick();
    ...
    private void get_data(final List<Srpt_readings.field> datas,final String customer) {
