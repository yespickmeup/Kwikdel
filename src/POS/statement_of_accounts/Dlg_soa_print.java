...
import static POS.statement_of_accounts.Srpt_readings.ret_data;
 ...
 * @author Guinness
 */
public class Dlg_soa_print extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_soa_print
     */
...
//</editor-fold>
    ...
    private Dlg_soa_print(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_soa_print(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_soa_print myRef;

    private void setThisRef(Dlg_soa_print myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_soa_print> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_soa_print create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_soa_print create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_soa_print dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_soa_print((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_soa_print((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_soa_print dialog = Dlg_soa_print.create(new javax.swing.JFrame(), true);
    ...
    public void do_pass(String where) {
        get_data(where);
    }
...
//                btn_0.doClick();
    ...
    private void get_data(final String where) {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                List<Srpt_readings.field> datas = ret_data(where);
    ...
    private void report_sales_items(final Srpt_readings to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_all_sales(Srpt_readings to, String rpt_name) {
