 ...
 * @author Guinness
 */
public class Dlg_ma_customers extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_ma_customers
     */
...
//</editor-fold>
    ...
    private Dlg_ma_customers(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_ma_customers(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_ma_customers myRef;

    private void setThisRef(Dlg_ma_customers myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_ma_customers> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_ma_customers create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_ma_customers create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_ma_customers dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_ma_customers((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_ma_customers((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_ma_customers dialog = Dlg_ma_customers.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jButton1.setText("Search Master Data");
...
//                btn_0.doClick();
    ...
    private void report_sales_items(final Srpt_customers to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_all_sales(Srpt_customers to, String rpt_name) {
        try {
