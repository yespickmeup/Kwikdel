 ...
 * @author Ronald
 */
public class Dlg_delivery_guide extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_delivery_guide
     */
...
//</editor-fold>
    ...
    private Dlg_delivery_guide(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private Dlg_delivery_guide(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_delivery_guide myRef;

    private void setThisRef(Dlg_delivery_guide myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_delivery_guide> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_delivery_guide create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_delivery_guide create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_delivery_guide dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_delivery_guide((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_delivery_guide((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_delivery_guide dialog = Dlg_delivery_guide.create(new javax.swing.JFrame(), true);
    ...
    public void do_pass(final List<Srpt_delivery_receipt.field> fields) {
...
//                btn_0.doClick();
    ...
    private void get_data(final List<Srpt_delivery_receipt.field> fields) {
    ...
    private void report_sales_items(final Srpt_delivery_receipt to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_all_sales(Srpt_delivery_receipt to, String rpt_name) {
        try {
