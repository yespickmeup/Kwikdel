 ...
 * @author Maytopacka
 */
public class Dlg_po_qty1 extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_po_qty1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_po_qty1(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_po_qty1 myRef;

    private void setThisRef(Dlg_po_qty1 myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_po_qty1> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_po_qty1 create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_po_qty1 create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_po_qty1 dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_po_qty1((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_po_qty1((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_po_qty1 dialog = Dlg_po_qty1.create(new javax.swing.JFrame(), true);
